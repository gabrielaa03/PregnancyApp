...
public class ThreatenedPregnancyAdapter extends ArrayAdapter<String> {
    private List<String> listItems = new ArrayList<>();
    private List<String> newItems = new ArrayList<>();
    private List<String> databaseItems = new ArrayList<>();
    private Context context;

    public ThreatenedPregnancyAdapter(@NonNull Context context, int resource, List<String> list, List<String> databaseItems) {
