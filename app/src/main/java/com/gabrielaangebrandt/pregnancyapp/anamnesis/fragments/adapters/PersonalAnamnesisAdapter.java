...
public class PersonalAnamnesisAdapter extends ArrayAdapter<String> {
    private List<String> listItems = new ArrayList<>();
    private List<String> databaseItems = new ArrayList<>();
    private Context context;

    public PersonalAnamnesisAdapter(@NonNull Context context, int resource, List<String> list, List<String> databaseItems) {
